...
@NamedQueries
({
    @NamedQuery(name = "findByDato", query = "Select f from FlightInstance f where f.dato LIKE :dato AND f.flight.airportFrom.IATACode = :from"),
    @NamedQuery(name = "findByDato1", query = "Select f from FlightInstance f where f.dato LIKE :dato AND f.flight.airportFrom.IATACode = :from AND f.flight.airportTo.IATACode = :to"),
